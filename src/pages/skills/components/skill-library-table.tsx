									...
									<div className="flex justify-end gap-sm">
										{skill.sourceType === "git" ? (
											<button
												...
												className="h-9 min-w-[80px] shrink-0 whitespace-nowrap rounded-md border border-hairline bg-surface-card text-body-sm font-medium text-ink outline-none hover:bg-surface-soft focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-focus-ring"
										...
										<button
											className="h-9 min-w-[80px] shrink-0 rounded-md border border-hairline bg-surface-card text-body-sm font-medium text-ink outline-none hover:bg-surface-soft focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-focus-ring"
