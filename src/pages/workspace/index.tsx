...
const WorkspacePage = () => {
	...
	return (
		<main
			className="relative flex h-dvh min-w-0 flex-1 flex-col overflow-hidden bg-canvas max-md:h-[calc(100dvh-4rem)]"
			ref={workspaceRef}
		>
			...
			<div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 bg-linear-to-t from-canvas via-canvas to-transparent px-3 pb-3 pt-16 sm:px-xl sm:pb-xl">
