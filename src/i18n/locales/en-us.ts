	...
	translation: {
		benchmark: {
			...
			checkKinds: {
				...
				file_text: "File text",
				file_json: "JSON output",
				python: "Python validator",
			},
			title: "Benchmarks",
			description:
				"Choose a benchmark. Mount it to a Workspace. Compare your Agents.",
			add: "Add new",
			all: "All benchmarks",
			tags: "Tags",
			...
			mount: "Mount",
			mountTitle: "Mount {{name}}",
			mounted: "Benchmark mounted",
			workspace: "Workspace",
			chooseWorkspace: "Choose a workspace",
			noWorkspaces: "Create a workspace from the sidebar first.",
			caseCount: "{{count}} cases",
			empty: "No benchmarks found. Create one or clear the filters.",
			...
			import: {
				...
				title: "Import Benchmark folder",
				chooseFolder: "Choose folder",
				chooseFolderTitle: "Choose a Benchmark template folder",
				noFolder: "No folder selected",
				folderHelp: "Select a folder containing benchmark.json.",
				previewFailed: "This folder is not a recognized Theoria template.",
				summary: "{{cases}} cases · {{files}} files",
				issues: "Items to repair in the draft",
				confirm: "Import draft",
				imported: "Benchmark draft imported",
			},
			name: "Name",
			...
			timeout: "Time limit (minutes)",
			addCase: "Add case",
			removeCase: "Remove case",
			removeCaseConfirm: "Remove this case from the draft?",
			save: "Save draft",
			publish: "Publish",
			saved: "Draft saved",
			...
			results: {
				...
				case: "Case",
				result: "Result",
				casePassSummary: "{{passed}}/{{total}} passed",
				caseComparison: "Case comparison",
				resize: "Resize Case comparison panel",
				metric: "Metric",
				status: "Status",
				...
				tool: "Tool",
				arguments: "Arguments",
				noToolCalls: "No tools were called in this run",
				toolStatus: {
					completed: "Completed",
					failed: "Failed",
				...
				tokenValue: "{{count}} tokens",
				toolValue: "{{count}} tools",
				noData: "No data",
				metricCoverage: "{{value}} ({{coverage}}/{{total}} cases)",
				...
				checkMessage: {
					answer_matched: "The final answer matched.",
					answer_mismatch: "The final answer did not match.",
					file_exists: "The required file exists.",
					file_missing: "The required file is missing.",
					text_matched: "The file text matched.",
					text_mismatch: "The file text did not match.",
					json_matched: "The JSON output matched.",
			...
			validation: {
				...
				import_too_large: "Keep the imported folder within 20 MB",
				file_too_large: "Keep each imported file within 5 MB",
				missing_file: "Add or replace the missing referenced file",
			...
			issues: {
				agent_not_installed: "Agent is not installed",
				agent_not_authenticated: "Agent is not authenticated",
				agent_check_failed: "Could not check Agent",
				asset_unavailable: "Starting material is unavailable",
				verifier_unavailable: "Validator environment is unavailable",
			},
		},
		appName: "theoria",
		...
		taskSummary: {
			...
			outputTokens: "Output",
			cachedTokens: "Cached",
			expandTokenDetails: "Expand token details",
			collapseTokenDetails: "Collapse token details",
			toolCalls: "Tool calls",
